(function() {
  ...
  _.last = function(array, n) {
    if(n === undefined){
      ...
      return array.slice(n-1, array.length+1);
    }
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    var total = (accumulator === undefined ? collection.shift() : accumulator);
    _.each(collection, function(item){
  ...
  _.defaults = function(obj) {
    for(var i = 1; i < arguments.length; i++){
      ...
      obj = _.extend.apply(this, arguments);
    }
  ...
  _.memoize = function(func) {
    ...
    return function() {
      if (!alreadyCalled || _.indexOf(args, arguments[0]) == -1) {
        result = func.apply(this, arguments);
        alreadyCalled = true;
        args.push(arguments[0]);
        results.push(result);
      } else {
        result = results[_.indexOf(args, arguments[0])];
      }
      return result;
    };
  };
